...
if ( ! class_exists( 'YITH_WooCommerce_Question_Answer_Premium' ) ) {
	...
	class YITH_WooCommerce_Question_Answer_Premium extends YITH_WooCommerce_Question_Answer {
		...
		public function get_helpful_answer_text( $discussion ) {
			...
			if ( $total > 0 ) {
				return sprintf( __( "%d of %d found it useful. What do you think?", 'yith-woocommerce-questions-and-answers' ), $stats["yes"], $total );
			}
		...
		public function submit_question_callback() {
			...
			wp_send_json( array(
				...
				"message"          => apply_filters ( 'yith_wcqa_question_success_message',__( "Thanks for your post. It has been sent to site administrator for approval.", 'yith-woocommerce-questions-and-answers' )),
			) );
		}
		...
		function submit_answer_callback() {
			...
			wp_send_json( array(
				...
				"message"          => apply_filters ( 'yith_wcqa_answer_success_message',__( "Thanks for your post. It has been sent to site administrator for approval.", 'yith-woocommerce-questions-and-answers' )),
			) );
