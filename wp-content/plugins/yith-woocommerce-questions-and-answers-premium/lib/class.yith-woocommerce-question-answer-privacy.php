...
if ( ! class_exists( 'YITH_WooCommerce_Question_And_Answer_Privacy' ) ) {
    ...
    class YITH_WooCommerce_Question_And_Answer_Privacy extends YITH_Privacy_Plugin_Abstract
    {
        ...
        public function __construct()
        {
             ...
             */
            parent::__construct( _x( 'YITH Question and Answers for WooCommerce premium', 'Privacy Policy Content', 'yith-woocommerce-advanced-reviews' ) );
            ...
            foreach ( $question_and_answers as $question_and_answer ) {
                ...
                if ( true !== $anon_message ) {
                    if ( $anon_message && is_string( $anon_message ) ) {
                        ...
                        $messages[] = sprintf( __( 'Review %d contains personal data but could not be anonymized.' ), $question_and_answer->ID );
                    }
