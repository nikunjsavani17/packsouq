...
//				require_once( YITH_YWBC_INCLUDES_DIR . 'class-yith-ywbc-backend.php' );
        ...
        public function ywqa_edit_post_author_custom_box() {
            $screens = ['post', 'question_answer'];
            foreach ($screens as $screen) {

                add_meta_box( 'ywqa_last_post_editor_box_id',  __( "Last Q&A editor", 'yith-woocommerce-questions-and-answers' ), array( $this,  'wporg_custom_box_html' ), $screen, 'side' );
            }
        }
        ...
        public function wporg_custom_box_html($post) {
             echo sprintf( __( "%s edited on %s", 'yith-woocommerce-questions-and-answers' ),
