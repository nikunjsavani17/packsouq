...
$advanced_options = array(
	...
	'advanced' => array(
        ...
        'ywqa_recaptcha_version'                     => array(
            'name'    => __ ( 'reCaptcha version', 'yith-woocommerce-questions-and-answers' ),
            'type'    => 'select',
            'options' => array(
                'v2' => __ ( 'reCaptcha v2', 'yith-woocommerce-questions-and-answers' ),
                'v3' => __ ( 'reCaptcha v3', 'yith-woocommerce-questions-and-answers' ),
            ),
            'desc'    => __ ( 'Choose the reCaptcha version.', 'yith-woocommerce-questions-and-answers' ),
