            ...
            <?php if ( YITH_YWQA()->anonymise_user ) : ?>
                <div class="question-owner">
                    ...
                    if ( current_user_can('administrator') || current_user_can('manage_woocommerce') ) {
                        ?><a class="edit-on-backend-link" href="<?php echo get_edit_post_link($question->ID); ?>" target="_blank"><?php _e("Edit on backend", 'yith-woocommerce-questions-and-answers'); ?></a>
                    <?php } ?>
                </div>
            <?php else: ?>
                <div class="question-owner">
    ...
    <div id="ywqa_answer_list">
		...
		<span
                ...
                <div class="order-by">
                    ...
                    <a rel="nofollow" class="ywqa-question-order" data-order="useful"><?php _e( "Most useful", 'yith-woocommerce-questions-and-answers' ); ?></a>
                    |
                    <a rel="nofollow" class="ywqa-question-order" data-order="recent"><?php _e( "Most recent", 'yith-woocommerce-questions-and-answers' ); ?></a>
                    |
                    <a rel="nofollow" class="ywqa-question-order" data-order="oldest"><?php _e( "Oldest", 'yith-woocommerce-questions-and-answers' ); ?></a>
                </div>
            </div>
